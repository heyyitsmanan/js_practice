...
// const dolphinR1 = 96, dolphinR2 = 108, dolphinR3 = 89;
// const koalaR1 = 88, koalaR2 = 91, koalaR3 = 110;

//* Scores for 2nd Bonus round

// const dolphinR1 = 97, dolphinR2 = 112, dolphinR3 = 101;
// const koalaR1 = 109, koalaR2 = 95, koalaR3 = 123;

//* Scores for 3rd Bonus round

const dolphinR1 = 97, dolphinR2 = 112, dolphinR3 = 101;
const koalaR1 = 109, koalaR2 = 95, koalaR3 = 106;

const dolphinAvgScore = (dolphinR1 + dolphinR2 + dolphinR3) / 3;
const koalaAvgScore = (koalaR1 + koalaR2 + koalaR3) / 3;

console.log(dolphinAvgScore, koalaAvgScore);

console.log(' ');
console.log(`Checking the winner using 1st criteria :- `);
console.log(' ');

if(dolphinAvgScore > koalaAvgScore){
    console.log(`Dolphin Team Won :D`);
}
else if (dolphinAvgScore === koalaAvgScore){
    console.log(`It's a draw between Dolphin's and Koala's`);
}
else{
    console.log(`Koala Team Won :D`);
}

console.log(' ');
console.log(`Checking the winner using 2nd criteria :- `);
console.log(' ');

const minReq = 100;

if((dolphinAvgScore === koalaAvgScore) && (dolphinAvgScore >= minReq) && (koalaAvgScore > minReq)){
    console.log(`It's a Draw between both teams :)`);
}
else if((dolphinAvgScore > koalaAvgScore) && (dolphinAvgScore >= minReq)){
    console.log(`Dolphin Team Won :D`);
}
else if((koalaAvgScore > dolphinAvgScore) && (koalaAvgScore >= minReq)){
    console.log(`Koala Team Won :D`);
}
else{
    console.log(`No Team won the cup :(`);
}
...
console.log(`The bill was ${billValue} and, the tip was ${tip} and, the total value ${billValue + tip}`);
