...
1. Create an arrow function 'fCalcAverage' to calculate the average of 3 scores
...
// const scoreDolphin1 = 44, scoreDolphin2 = 23, scoreDolphin3 = 71;
// const scoreKoala1 = 65, scoreKoala2 = 54, scoreKoala3 = 49;

//* Test Data 2

const scoreDolphin1 = 85, scoreDolphin2 = 54, scoreDolphin3 = 41;
const scoreKoala1 = 23, scoreKoala2 = 34, scoreKoala3 = 27;

const fCalcAverage = (score1, score2, score3) => (score1 + score2 + score3) / 3;

const avgDolphins = fCalcAverage(scoreDolphin1, scoreDolphin2, scoreDolphin3);
const avgKoalas = fCalcAverage(scoreKoala1, scoreKoala2, scoreKoala3);

const checkWinner = function (avgScore1, avgScore2){
  if(avgScore1 >= (2 * avgScore2)){
    console.log(`Dolphins Won (${avgScore1} vs. ${avgScore2})`);
  }
  else if(avgScore2 >= (2 * avgScore1)){
    console.log(`Koalas Won (${avgScore2} vs. ${avgScore1})`);
  }
  else{
